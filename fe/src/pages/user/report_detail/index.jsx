        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-0 lg:divide-x lg:divide-gray-300">
          ...
          <div className="lg:pr-12 flex flex-col">
            ...
            <div className="space-y-4 mb-8 text-base">
              <p>
                <span className="text-black">Nama pelapor:</span> Jarvis
              </p>

              <p>
                <span className="text-black">Nomor Laporan:</span> #1B03032026
              </p>

              <p>
                <span className="text-black">Tanggal Laporan:</span> 3 maret
                2026, 10:00 WIB
              </p>

              <p>
                <span className="text-black">Lokasi:</span> 4377+XHW, Belian,
            ...
            <div className="relative bg-gray-50/50 border border-gray-300 rounded-2xl p-6 mb-8 mt-2">
              ...
              <p className="text-black text-sm md:text-base leading-relaxed">
                saya mau lapor kondisi drainase di area sekitar Batam Centre
                yang setiap hujan deras sebentar saja pasti langsung meluap dan
                bikin banjir genangan setinggi betis orang dewasa. Airnya sampai
                masuk ke teras ruko dan bikin banyak kendaraan mogok karena
                nekat menerjang genangan, alhasil macetnya jadi panjang banget.
                Sepertinya gorong-gorong di sini tersumbat sampah plastik atau
                memang sudah terlalu sempit untuk menampung debit air yang makin
                tinggi belakangan ini. Mohon segera ditinjau ya tim teknisnya,
                karena ini bahaya banget buat keselamatan pengendara, apalagi
                kalau malam hari lubang jalannya jadi nggak kelihatan karena
                tertutup air. Makasih!
              </p>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="aspect-square bg-[#f0f2f5] rounded-3xl flex items-center justify-center">
                  <svg
                    className="w-16 h-16 text-[#a0abb8]"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <div className="relative border-l border-gray-300 ml-5 space-y-10">
                ...
                <div className="relative pl-10">
                  ...
                  <p className="text-[13px] text-gray-500 mt-1.5 leading-relaxed">
                    Sistem telah menerima laporanmu. Saat ini AI kami sedang
                    memvalidasi keaslian foto dan mengecek apakah ada laporan
                ...
                <div className="relative pl-10">
                  ...
                  <p className="text-[13px] text-gray-500 mt-1.5 leading-relaxed">
                    Laporanmu sudah lolos pengecekan AI dan sekarang sedang
                    ditinjau oleh Admin untuk diteruskan ke dinas teknis terkait.
                  </p>
                </div>
